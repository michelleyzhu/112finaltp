...
img = Image.open(f'graphics/backgrounds.png')
w,h = img.size
img = img.resize((w//4,h//4))
img.save(f'graphics/labels/backgrounds.png','PNG')
img = Image.open(f'graphics/backgroundsHover.png')
w,h = img.size
img = img.resize((w//4,h//4))
img.save(f'graphics/labels/backgroundsHover.png','PNG')
